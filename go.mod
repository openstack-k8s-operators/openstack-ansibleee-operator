...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/common 12cc1e43cccd
	github.com/openstack-k8s-operators/lib-common/modules/storage 12cc1e43cccd
	github.com/openstack-k8s-operators/lib-common/modules/test-operators 12cc1e43cccd
